"""LangChain tools for L402-gated API access via bolt402.
...
from bolt402 import L402Client, L402Response
...
class L402FetchTool(BaseTool):
    ...
    Token caching is handled by bolt402 so repeated requests to the same
