//! Interactive demo of the bolt402 L402 client.
//!
...
async fn main() {
    println!("╔══════════════════════════════════════════════════╗");
    println!("║           bolt402 — L402 Client Demo            ║");
    println!("╚══════════════════════════════════════════════════╝");
    println!();
    ...
    let client = L402Client::builder()
        ...
        .config(L402ClientConfig {
            max_fee_sats: 1000,
            max_retries: 1,
            user_agent: "bolt402-demo/0.1".to_string(),
        })
        .build()
    ...
    let total: u64 = receipts
        .iter()
        .map(bolt402_core::receipt::Receipt::total_cost_sats)
        .sum();
    println!();
